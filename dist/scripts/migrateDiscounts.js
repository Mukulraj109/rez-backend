...
async function migrateDiscounts() {
    try {
        ...
        const discountsToUpdate = await Discount_1.default.find({
            $or: [
                { scope: { $exists: false } },
        ...
        const updateResult = await Discount_1.default.updateMany({
            $or: [
                { scope: { $exists: false } },
                { createdByType: { $exists: false } }
            ]
        ...
        // Verify migration
        const remaining = await Discount_1.default.countDocuments({
            $or: [
                { scope: { $exists: false } },
                { createdByType: { $exists: false } }
            ]
...
exports.default = migrateDiscounts;
