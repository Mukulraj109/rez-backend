...
exports.verifyGameProduction = verifyGameProduction;
...
async function verifyGameProduction() {
    ...
    try {
        ...
        try {
            ...
            report.models.QuizQuestion.exported = typeof models_1.QuizQuestion !== 'undefined';
            const totalQuizCount = await models_1.QuizQuestion.countDocuments();
            const activeQuizCount = await models_1.QuizQuestion.countDocuments({ isActive: true });
            report.models.QuizQuestion.totalCount = totalQuizCount;
            report.models.QuizQuestion.activeCount = activeQuizCount;
            // Get category breakdown
            const categoryAgg = await models_1.QuizQuestion.aggregate([
            ...
            const difficultyAgg = await models_1.QuizQuestion.aggregate([
        ...
        try {
            ...
            report.models.TriviaQuestion.exported = typeof models_1.TriviaQuestion !== 'undefined';
            const totalTriviaCount = await models_1.TriviaQuestion.countDocuments();
            const activeTriviaCount = await models_1.TriviaQuestion.countDocuments({ isActive: true });
            report.models.TriviaQuestion.totalCount = totalTriviaCount;
            report.models.TriviaQuestion.activeCount = activeTriviaCount;
            // Get category breakdown
            const categoryAgg = await models_1.TriviaQuestion.aggregate([
                { $group: { _id: '$category', count: { $sum: 1 } } },
            ]);
            categoryAgg.forEach(item => {
            ...
            // Get difficulty breakdown
            const difficultyAgg = await models_1.TriviaQuestion.aggregate([
                { $group: { _id: '$difficulty', count: { $sum: 1 } } },
            ]);
            difficultyAgg.forEach(item => {
        ...
        try {
            ...
            report.models.GameSession.exported = typeof GameSession_1.default !== 'undefined';
            const totalSessionCount = await GameSession_1.default.countDocuments();
            report.models.GameSession.totalCount = totalSessionCount;
            // Get status breakdown
            const statusAgg = await GameSession_1.default.aggregate([
            ...
            const gameTypeAgg = await GameSession_1.default.aggregate([
        ...
        try {
            ...
            const randomQuestions = await models_1.QuizQuestion.getRandomQuestions(5);
        ...
        try {
            ...
            const easyQuestions = await models_1.QuizQuestion.getQuestionsByDifficulty('easy', 5);
        ...
        try {
            ...
            const shoppingQuestions = await models_1.QuizQuestion.getQuestionsByCategory('shopping', 5);
        ...
        try {
            ...
            const randomTrivia = await models_1.TriviaQuestion.getRandomTrivia(3);
        ...
        try {
            ...
            const scienceTrivia = await models_1.TriviaQuestion.getTriviaByCategory('science', 3);
        ...
        try {
            ...
            const expireResult = await GameSession_1.default.expireSessions();
