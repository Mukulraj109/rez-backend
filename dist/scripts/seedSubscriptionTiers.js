...
const SubscriptionTier_1 = require("../models/SubscriptionTier");
...
async function seedSubscriptionTiers() {
    try {
        ...
        await SubscriptionTier_1.SubscriptionTier.deleteMany({});
        console.log('🗑️  Cleared existing subscription tiers');
        // Insert new tiers
        const inserted = await SubscriptionTier_1.SubscriptionTier.insertMany(subscriptionTiers);
