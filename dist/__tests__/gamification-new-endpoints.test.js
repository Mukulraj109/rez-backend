...
describe('New Gamification Endpoints', () => {
    ...
    beforeEach(() => {
        ...
        mockReq = {
            user: {
                _id: new mongoose_1.Types.ObjectId('507f1f77bcf86cd799439011'),
    ...
    describe('GET /api/gamification/challenges/my-progress', () => {
        it('should return user challenge progress with stats', async () => {
            ...
            await (0, gamificationController_1.getMyChallengeProgress)(mockReq, mockRes, jest.fn());
        ...
        it('should require authentication', async () => {
            ...
            await expect((0, gamificationController_1.getMyChallengeProgress)(mockReq, mockRes, jest.fn())).rejects.toThrow('Authentication required');
        });
    });
    describe('GET /api/gamification/streaks', () => {
        it('should return current user login streak', async () => {
            ...
            await streakController_1.default.getCurrentUserStreak(mockReq, mockRes);
            expect(mockJson).toHaveBeenCalledWith(expect.objectContaining({
                success: true,
    ...
    describe('GET /api/gamification/stats', () => {
        it('should return comprehensive gamification stats', async () => {
            ...
            await (0, gamificationController_1.getGamificationStats)(mockReq, mockRes, jest.fn());
            expect(mockJson).toHaveBeenCalledWith(expect.objectContaining({
                success: true,
        ...
        it('should require authentication', async () => {
            mockReq.user = undefined;
            await expect((0, gamificationController_1.getGamificationStats)(mockReq, mockRes, jest.fn())).rejects.toThrow('Authentication required');
        });
