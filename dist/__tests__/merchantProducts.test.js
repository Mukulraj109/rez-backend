...
describe('Merchant Products', () => {
    ...
    let category;
    beforeEach(async () => {
        merchant = await (0, testUtils_1.createTestMerchant)();
        token = (0, testUtils_1.generateMerchantToken)(merchant.id);
        // Create a category
        ...
        store = await Store_1.Store.create({
            name: 'Test Store',
    ...
    describe('POST /api/merchant/products', () => {
        ...
        it('should reject duplicate SKU', async () => {
            ...
            await MerchantProduct_1.MProduct.create({
                merchantId: merchant._id,
                name: 'First Product',
    ...
    describe('GET /api/merchant/products/:id', () => {
        let testProduct;
        beforeEach(async () => {
            testProduct = await MerchantProduct_1.MProduct.create({
                merchantId: merchant._id,
                name: 'Single Product',
        ...
        it('should not allow access to another merchant\'s product', async () => {
            ...
            const otherMerchant = await (0, testUtils_1.createTestMerchant)({ email: `other${Date.now()}@example.com` });
            // Create product for other merchant
            const otherProduct = await MerchantProduct_1.MProduct.create({
    ...
    describe('DELETE /api/merchant/products/:id', () => {
        ...
        it('should delete a product', async () => {
            ...
            const deletedProduct = await MerchantProduct_1.MProduct.findById(testProduct._id);
