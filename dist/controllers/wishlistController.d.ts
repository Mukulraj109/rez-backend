...
export declare const getDefaultWishlist: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const checkWishlistStatus: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const removeItemByTypeAndId: (req: Request, res: Response, next: import("express").NextFunction) => void;
