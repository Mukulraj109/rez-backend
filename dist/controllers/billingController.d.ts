 ...
 */
export declare const getBillingHistory: (req: Request, res: Response) => Promise<any>;
/**
 * Get specific invoice details
 * GET /api/billing/invoice/:transactionId
 */
export declare const getInvoice: (req: Request, res: Response) => Promise<any>;
/**
 ...
 */
export declare const downloadInvoice: (req: Request, res: Response) => Promise<any>;
/**
 * Get billing statistics/summary
 * GET /api/billing/summary
 */
export declare const getBillingSummary: (req: Request, res: Response) => Promise<any>;
