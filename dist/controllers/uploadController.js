...
exports.uploadReviewImage = exports.uploadMultipleProjectFiles = exports.uploadProjectFile = void 0;
 ...
 * Note: File is already uploaded to Cloudinary by multer-storage-cloudinary
 */
exports.uploadReviewImage = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    if (!req.user) {
        throw new errorHandler_1.AppError('Authentication required', 401);
    }
    // Check if file is uploaded
    if (!req.file) {
        return (0, response_1.sendBadRequest)(res, 'Image is required');
    }
    const userId = req.user._id;
    try {
        ...
        throw new errorHandler_1.AppError(`Failed to process image: ${error.message}`, 500);
    }
});
