 ...
 */
export declare const getOutletById: (req: Request, res: Response) => Promise<any>;
/**
 ...
 */
export declare const getNearbyOutlets: (req: Request, res: Response) => Promise<any>;
/**
 * GET /api/outlets/:id/opening-hours
 * Get opening hours for a specific outlet
 */
export declare const getOutletOpeningHours: (req: Request, res: Response) => Promise<any>;
/**
 * GET /api/outlets/:id/offers
 * Get offers available at a specific outlet
 */
export declare const getOutletOffers: (req: Request, res: Response) => Promise<any>;
/**
 * POST /api/outlets/search
 * Search outlets by name or address
 */
export declare const searchOutlets: (req: Request, res: Response) => Promise<any>;
/**
