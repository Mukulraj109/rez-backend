 ...
 */
export declare const searchOffers: (req: Request, res: Response) => Promise<any>;
/**
 ...
 */
export declare const getOfferById: (req: Request, res: Response) => Promise<any>;
/**
 * POST /api/offers/:id/redeem
 * Redeem an offer (authenticated users only)
 */
export declare const redeemOffer: (req: Request, res: Response) => Promise<any>;
/**
 ...
 */
export declare const addOfferToFavorites: (req: Request, res: Response) => Promise<any>;
/**
 * DELETE /api/offers/:id/favorite
 * Remove offer from favorites
 */
export declare const removeOfferFromFavorites: (req: Request, res: Response) => Promise<any>;
/**
 ...
 */
export declare const getNearbyOffers: (req: Request, res: Response) => Promise<any>;
/**
 ...
 */
export declare const toggleOfferLike: (req: Request, res: Response) => Promise<any>;
/**
 * POST /api/offers/:id/share
 * Share an offer
 */
export declare const shareOffer: (req: Request, res: Response) => Promise<any>;
/**
