 ...
 * @access  Private
 */
export declare const getUserScratchCards: (req: Request, res: Response, next: import("express").NextFunction) => void;
/**
 ...
 * @access  Private
 */
export declare const claimPrize: (req: Request, res: Response, next: import("express").NextFunction) => void;
/**
 * @desc    Check if user is eligible for scratch card
 * @route   GET /api/scratch-cards/eligibility
 * @access  Private
 */
export declare const checkEligibility: (req: Request, res: Response, next: import("express").NextFunction) => void;
