 ...
 */
export declare const getDiscountById: (req: Request, res: Response) => Promise<any>;
/**
 ...
 */
export declare const validateDiscount: (req: Request, res: Response) => Promise<any>;
/**
 * POST /api/discounts/apply
 * Apply discount to an order (authenticated users only)
 */
export declare const applyDiscount: (req: Request, res: Response) => Promise<any>;
/**
 ...
 */
export declare const getDiscountAnalytics: (req: Request, res: Response) => Promise<any>;
/**
