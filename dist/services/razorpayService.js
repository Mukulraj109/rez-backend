...
exports.razorpayService = exports.createRazorpayRefund = void 0;
...
exports.createRazorpayPayout = createRazorpayPayout;
 ...
 */
async function createRazorpayPayout(params) {
    try {
        const razorpay = getRazorpayInstance();
        const payoutData = {
 ...
 */
exports.createRazorpayRefund = createRefund;
exports.razorpayService = {
    createOrder: createRazorpayOrder,
    verifySignature: verifyRazorpaySignature,
    fetchPaymentDetails,
    createRefund,
    createRazorpayRefund: exports.createRazorpayRefund,
