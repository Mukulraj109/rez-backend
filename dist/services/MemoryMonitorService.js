...
MemoryMonitorService.snapshots = [];
MemoryMonitorService.monitorInterval = null;
MemoryMonitorService.MAX_SNAPSHOTS = 1000;
MemoryMonitorService.SNAPSHOT_INTERVAL = 30000; // 30 seconds
MemoryMonitorService.MEMORY_THRESHOLD = 0.85; // 85% of max
MemoryMonitorService.MAX_HEAP_SIZE = 512 * 1024 * 1024; // 512MB default
MemoryMonitorService.peakSnapshot = null;
MemoryMonitorService.alertCallbacks = [];
