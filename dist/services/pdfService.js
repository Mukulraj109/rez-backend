...
class PDFService {
     ...
     */
    static async generateInvoicePDF(res, invoiceData, userInfo) {
        return new Promise((resolve, reject) => {
            try {
                ...
                res.setHeader('Content-Disposition', `attachment; filename=invoice-${invoiceData._id || invoiceData.paymentId}.pdf`);
     ...
     */
    static addInvoiceDetails(doc, invoiceData) {
     ...
     */
    static addBillingInfo(doc, userInfo) {
        doc
            .fontSize(12)
            .font('Helvetica-Bold')
            .text('BILL TO:', 50, 270);
     ...
     * Add items table
     */
    static addItemsTable(doc, invoiceData) {
        const tableTop = 380;
        const itemHeight = 30;
        // Table header
        doc
    ...
    static addFooter(doc) {
        ...
        doc
            .fontSize(8)
            .fillColor('#666666')
            .text('REZ APP - Your Shopping Companion | www.rezapp.com', 50, 760, { align: 'center', width: 500 });
    }
}
