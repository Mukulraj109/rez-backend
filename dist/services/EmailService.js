...
class EmailService {
     ...
     */
    static async sendPasswordChangeConfirmation(merchantEmail, merchantName) {
        const html = `
      <!DOCTYPE html>
      <html>
      <head>
     ...
     */
    static async sendWelcomeEmail(merchantEmail, merchantName, businessName) {
        const html = `
      <!DOCTYPE html>
      <html>
      <head>
     ...
     */
    static async sendEmailVerification(merchantEmail, merchantName, verificationToken) {
     ...
     */
    static async sendPasswordResetEmail(merchantEmail, merchantName, resetToken) {
     ...
     */
    static async sendLowStockAlert(merchantEmail, merchantName, products) {
     ...
     */
    static async sendNewOrderNotification(merchantEmail, merchantName, orderDetails) {
        const html = `
      <!DOCTYPE html>
      <html>
      <head>
     ...
     */
    static async sendOnboardingStepCompleted(merchantEmail, merchantName, stepNumber, stepName) {
        const html = `
      <!DOCTYPE html>
      <html>
      <head>
     ...
     */
    static async sendOnboardingSubmitted(merchantEmail, merchantName) {
        const html = `
      <!DOCTYPE html>
      <html>
      <head>
     ...
     */
    static async sendOnboardingApproved(merchantEmail, merchantName, storeId) {
        const html = `
      <!DOCTYPE html>
      <html>
      <head>
     ...
     */
    static async sendOnboardingRejected(merchantEmail, merchantName, reason) {
        const html = `
      <!DOCTYPE html>
      <html>
      <head>
     ...
     */
    static async sendDocumentVerificationComplete(merchantEmail, merchantName, approved, reason) {
        const html = approved ? `
      <!DOCTYPE html>
      <html>
      <head>
     ...
     */
    static async sendDocumentApproved(merchantEmail, merchantName, documentName) {
        const html = `
      <!DOCTYPE html>
      <html>
      <head>
     ...
     */
    static async sendDocumentRejected(merchantEmail, merchantName, documentName, reason) {
        const html = `
      <!DOCTYPE html>
      <html>
      <head>
     ...
     */
    static async sendAdditionalDocumentsRequest(merchantEmail, merchantName, documentTypes, message) {
     ...
     */
    static async sendAdminOnboardingNotification(adminEmail, businessName, merchantId) {
        const html = `
      <!DOCTYPE html>
      <html>
      <head>
     ...
     */
    static async sendUserOTP(userEmail, userName, otp, phoneNumber) {
        const html = `
      <!DOCTYPE html>
      <html>
      <head>
     ...
     */
    static async sendOrderStatusUpdate(userEmail, userName, orderDetails) {
        const statusColors = {
            confirmed: '#2196F3',
            preparing: '#FF9800',
            ready: '#9C27B0',
     ...
     */
    static async sendUserWelcomeEmail(userEmail, userName, referralCode) {
        const html = `
      <!DOCTYPE html>
      <html>
      <head>
     ...
     */
    static async sendUserPasswordReset(userEmail, userName, resetToken) {
     ...
     */
    static async sendCashbackNotification(userEmail, userName, cashbackDetails) {
        const html = `
      <!DOCTYPE html>
      <html>
      <head>
     ...
     */
    static async sendReferralReward(userEmail, userName, rewardDetails) {
        const html = `
      <!DOCTYPE html>
      <html>
      <head>
     ...
     */
    static async sendRefundConfirmation(email, userName, refundDetails) {
     ...
     */
    static async sendRefundRequestNotification(merchantEmail, storeName, refundDetails) {
        const html = `
      <!DOCTYPE html>
      <html>
      <head>
     ...
     */
    static async sendAdminRefundRequestNotification(adminEmail, refundDetails) {
        const html = `
      <!DOCTYPE html>
      <html>
      <head>
...
EmailService.FROM_EMAIL = process.env.SENDGRID_FROM_EMAIL || 'noreply@yourstore.com';
EmailService.FROM_NAME = process.env.SENDGRID_FROM_NAME || 'Your Store';
