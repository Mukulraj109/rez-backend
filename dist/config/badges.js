...
exports.getReviewBadges = exports.getProfileBadges = exports.getBadgesByRarity = exports.getBadgesByType = exports.BADGES = void 0;
exports.BADGES = {
...
const getBadgesByType = (type) => {
    return Object.values(exports.BADGES).filter(b => b.type === type);
};
exports.getBadgesByType = getBadgesByType;
// Get badges by rarity
const getBadgesByRarity = (rarity) => {
    return Object.values(exports.BADGES).filter(b => b.rarity === rarity);
};
exports.getBadgesByRarity = getBadgesByRarity;
// Get displayable badges
const getProfileBadges = () => {
    return Object.values(exports.BADGES).filter(b => b.displayOnProfile);
};
exports.getProfileBadges = getProfileBadges;
const getReviewBadges = () => {
    return Object.values(exports.BADGES).filter(b => b.displayOnReviews);
};
exports.getReviewBadges = getReviewBadges;
exports.default = exports.BADGES;
