...
exports.CSRF_CONFIG = exports.requireCsrfToken = void 0;
exports.generateCsrfToken = generateCsrfToken;
exports.setCsrfToken = setCsrfToken;
exports.validateCsrfToken = validateCsrfToken;
exports.csrfProtection = csrfProtection;
exports.getCsrfToken = getCsrfToken;
exports.hasCsrfToken = hasCsrfToken;
...
function verifyToken(token1, token2) {
    ...
    try {
        return crypto_1.default.timingSafeEqual(Buffer.from(token1, 'utf-8'), Buffer.from(token2, 'utf-8'));
    }
    catch (error) {
        return false;
    }
 ...
 */
function shouldExemptFromCsrf(req) {
...
function setCsrfToken(req, res, next) {
    try {
        ...
        if (!csrfToken || csrfToken.length !== CSRF_TOKEN_LENGTH * 2) {
            ...
            logger_1.logger.debug('Generated new CSRF token', {
                path: req.path,
                method: req.method
            });
        }
        ...
        logger_1.logger.error('Error setting CSRF token', {
            error: error.message,
            path: req.path,
            method: req.method
        });
...
function validateCsrfToken(req, res, next) {
    try {
        ...
        if (shouldExemptFromCsrf(req)) {
            logger_1.logger.debug('Request exempted from CSRF protection', {
                path: req.path,
                method: req.method,
        ...
        if (!cookieToken) {
            logger_1.logger.warn('CSRF validation failed: No token in cookie', {
                path: req.path,
                method: req.method,
                ip: req.ip,
        ...
        if (!headerToken) {
            logger_1.logger.warn('CSRF validation failed: No token in header', {
                path: req.path,
                method: req.method,
                ip: req.ip,
                userAgent: req.headers['user-agent']
        ...
        logger_1.logger.error('Error validating CSRF token', {
            error: error.message,
            path: req.path,
            method: req.method
        });
 ...
 */
exports.requireCsrfToken = validateCsrfToken;
/**
...
function getCsrfToken(req) {
    return {
        ...
        header: req.headers[CSRF_HEADER_NAME]
    };
}
/**
