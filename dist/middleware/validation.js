...
exports.productSchemas = {
    getProducts: joi_1.default.object({
        ...
        excludeProducts: joi_1.default.string().optional().pattern(/^[0-9a-fA-F]{24}(,[0-9a-fA-F]{24})*$/).messages({
            'string.pattern.base': 'excludeProducts must be comma-separated valid MongoDB ObjectIds'
        }),
        diversityMode: joi_1.default.string().valid('balanced', 'category_diverse', 'price_diverse', 'none').default('none').messages({
...
exports.wishlistSchemas = {
    ...
    addToWishlist: joi_1.default.object({
        ...
        itemType: joi_1.default.string().valid('Product', 'Store', 'Video', 'product', 'store', 'video').required(),
