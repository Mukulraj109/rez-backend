...
router.get('/metrics', async (req, res) => {
    try {
        ...
        const metrics = await BusinessMetrics_1.BusinessMetricsService.getDashboardMetrics(merchantId);
        return res.json({
            success: true,
            data: metrics
        });
...
router.get('/timeseries', async (req, res) => {
    try {
        ...
        const timeSeriesData = await BusinessMetrics_1.BusinessMetricsService.getTimeSeriesData(merchantId, parseInt(days));
        return res.json({
            success: true,
            data: timeSeriesData
        });
...
router.get('/top-products', async (req, res) => {
    try {
        ...
        const topProductsResult = await MerchantProduct_1.ProductModel.search({
            merchantId,
            sortBy: 'price',
            sortOrder: 'desc',
    ...
    try {
        ...
        if (type === 'overview') {
            const [metrics, timeSeriesData, categoryPerformance] = await Promise.all([
                ...
                BusinessMetrics_1.BusinessMetricsService.getTimeSeriesData(merchantId, days),
...
router.get('/categories', async (req, res) => {
    try {
        ...
        const categoryPerformance = await BusinessMetrics_1.BusinessMetricsService.getCategoryPerformance(merchantId);
        return res.json({
            success: true,
...
router.get('/customers', async (req, res) => {
    try {
        ...
        const customerInsights = await BusinessMetrics_1.BusinessMetricsService.getCustomerInsights(merchantId);
        return res.json({
            success: true,
...
router.get('/insights', async (req, res) => {
    try {
        ...
        const insights = await BusinessMetrics_1.BusinessMetricsService.getBusinessInsights(merchantId);
        return res.json({
            success: true,
            data: insights
        });
