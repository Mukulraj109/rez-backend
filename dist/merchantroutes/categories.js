...
const searchCategoriesSchema = joi_1.default.object({
    ...
    parentId: joi_1.default.string().optional(),
    storeId: joi_1.default.string().optional(), // Add storeId filter
...
router.get('/stats', async (req, res) => {
    try {
        ...
        const productMatchCriteria = { merchantId: req.merchantId };
        ...
        if (storeId) {
            ...
            productMatchCriteria.storeId = new mongoose_1.default.Types.ObjectId(storeId);
        }
        ...
        const topCategoriesMatchCriteria = {
...
router.get('/', (0, merchantvalidation_1.validateQuery)(searchCategoriesSchema), async (req, res) => {
    try {
        const { query, parentId, storeId, isActive, sortBy, sortOrder, includeEmpty } = req.query;
